...
export default {
    async fetch(req: Request, env: Env): Promise<Response> {
        ...
        if (url.pathname.startsWith("/api/research")) {
            ...
            // This allows clients to poll for completion and get results
            ...
            // This creates a durable workflow that can run for minutes/hours
            // Cloudflare Workflows handle the execution and state management
